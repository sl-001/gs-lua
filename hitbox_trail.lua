...
local int = {
    ...
    hitbox = ui.new_multiselect("lua", "a", "\n\n", "Head", "Neck", "Shoulder part", "Upper chest", "Chest", "Stomach", "Pelvis", "Left arm", "Left forearm", "Left hand", "Left thigh", "Left leg", "Left foot", "Right arm", "Right forearm", "Right hand", "Right thigh", "Right leg", "Right foot"),
